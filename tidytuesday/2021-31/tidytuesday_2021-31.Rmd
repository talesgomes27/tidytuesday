...
new_title <-
  ...
  gtable_add_grob(
    textGrob(
      label = "Participação olímpica feminina média de 1948 à 2016",
      x = unit(0, "npc"),
      just = "left",
      gp = gpar(fontsize = 44)
    ),
...
for (i in 1:3) {
  ...
  country_title <- str_c(
    "Participação olímpica feminina de 1964 à 2016 no",
    countrys_names[i],
    sep = " "
  )
...
new_title <- gtable(unit(c(1, 13.2, 1), "in"), unit(0.9, "in")) |>
  ...
  gtable_add_grob(
    textGrob(
      label = "Total de medalhas por gênero de 1948 à 2016",
      x = unit(0, "npc"),
      just = "left",
      gp = gpar(fontsize = 46)
    ),
...
for (i in 1:3) {
  ...
  country_title <- str_c("Total de medalhas por gênero de 1948 à 2016 no",
                         countrys_names[i],
                         sep = " ")
